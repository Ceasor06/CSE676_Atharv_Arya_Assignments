"CSE676_Ass_1.py" file contains the code for Assignment1, in which I designed an FNN for MNIST classification and the plot training and test loss is also included in the ipynb file.
